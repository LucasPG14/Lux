...
namespace Lux
{
	Material::Material(uint32_t newId) : id(newId), albedoColor(1.0f, 0.0f, 0.0f, 1.0f), type(0), refractionIndex(1.5f), metallic(0.0f), roughness(0.5f), emissive(1.0, 1.0, 1.0, 0.0f)
	{
